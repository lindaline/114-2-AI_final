...
def open_test(name):
    ...
    result_text.set(done)       # ★ 只更新文字，不再新建 Message

label = tk.Label(root, text='請輸入使用者名稱(英文)', font=('清松手寫體1',16,'bold'))
label.pack()
